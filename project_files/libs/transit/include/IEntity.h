...
class IEntity {
 public:
  ...
  /**
   * @brief Helper function to generate a random float.
   * @param Min A float for the lower bound of the random float.
   * @param Max A float for the upper bound of the random float.
