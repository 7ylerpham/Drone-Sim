  ...
  try {
    api.onmessage = function(msg, data)  {
      if ("event" in data) {
        ...
        if (data.event == "SendWeatherDetails"){
          windDirection = data.details.windDirection;
          windSpeed = data.details.windSpeed;
          weatherType = data.details.weatherType;
          weatherTypeDiv.textContent = "Weather Type: " + weatherType;
          windSpeedDiv.textContent = "Wind Speed: " + windSpeed;
          windDirectionDiv.textContent = "Wind Direction: " + windDirection;
        }
      }
    }
  }
